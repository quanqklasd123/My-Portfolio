        ...
        <div>
          ...
          >
            <Badge className="mb-6 bg-background/85 text-foreground">
              ...
              Available for international internship opportunities
            </Badge>
            ...
            <h1 className="mt-5 max-w-3xl text-5xl font-semibold leading-[1.05] tracking-tight sm:text-6xl lg:text-7xl">
              ...
              <span className="text-gradient"> frontend polish </span>
              and backend clarity.
            </h1>
              ...
              <div className="flex flex-col gap-4">
                <div className="rounded-[2rem] border border-white/10 bg-slate-950 p-6 text-slate-50 dark:bg-slate-900">
                  ...
                  <p className="mt-4 text-xl font-semibold leading-snug">
                    I care about experiences that feel as intentional as the code behind them.
                  </p>
                </div>
                <div className="glass-panel rounded-[2rem] p-6">
                  <p className="text-sm font-semibold text-foreground">Current focus</p>
                  <ul className="mt-4 space-y-3 text-sm leading-6 text-muted-foreground">
                    <li>Responsive React interfaces with premium visual rhythm</li>
                    <li>Backend services in Spring Boot, Node.js, and .NET</li>
                    <li>Portfolio-ready projects for international company applications</li>
                  </ul>
                </div>
